...
class InstitutionMyProfileScreen extends StatefulWidget {
  const InstitutionMyProfileScreen({super.key});

  @override
  State<InstitutionMyProfileScreen> createState() => _InstitutionMyProfileScreenState();
}

class _InstitutionMyProfileScreenState extends State<InstitutionMyProfileScreen> {
  ...
  Future<void> _loadProfile() async {
    ...
    try {
      final response = await ApiService.getInstitutionMyProfile(
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                        ...
                                        ? Image.network(
                                            ...
                                            errorBuilder: (context, error, stackTrace) {
                                              return _buildAvatarPlaceholder(
                                                _profileData!['title'] ?? _profileData!['username'] ?? 'I',
                                              );
                                            },
                                          )
                                ...
                                // Title
                                Text(
                                  _profileData!['title'] ?? _profileData!['username'] ?? 'Institution',
                                  style: const TextStyle(
                                    fontSize: 24,
                                    fontWeight: FontWeight.bold,
                                    color: Colors.white,
