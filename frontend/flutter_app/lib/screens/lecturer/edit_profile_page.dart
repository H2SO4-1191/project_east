...
class LecturerEditProfilePage extends StatefulWidget {
  const LecturerEditProfilePage({super.key});

  @override
  State<LecturerEditProfilePage> createState() => _LecturerEditProfilePageState();
}

class _LecturerEditProfilePageState extends State<LecturerEditProfilePage> {
  ...
  String? _selectedAcademicAchievement;
  ...
  static const List<String> _academicAchievements = [
    'bachelors',
    'masters',
    'phd',
  ];
  ...
  Future<void> _submitEdit() async {
    ...
    try {
      ...
      if (_selectedAcademicAchievement != null) {
        payload['academic_achievement'] = _selectedAcademicAchievement!;
      }
      ...
      if (_skillsController.text.trim().isNotEmpty) {
        payload['skills'] = _skillsController.text.trim();
      }
      if (_experienceController.text.trim().isNotEmpty) {
        payload['experience'] = _experienceController.text.trim();
      }
      ...
      final result = await ApiService.editLecturerProfile(
        accessToken: accessToken,
        payload: payload,
        refreshToken: refreshToken,
        onTokenRefreshed: (tokens) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edit Lecturer Profile'),
        elevation: 0,
      ),
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Update your lecturer information',
                  ...
                  return GridView.count(
                    ...
                    children: [
                      _buildDropdownField(
                        ...
                        _academicAchievements,
                        (value) => setState(() => _selectedAcademicAchievement = value),
                      ),
