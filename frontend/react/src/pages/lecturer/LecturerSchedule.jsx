...
const LecturerSchedule = () => {
  ...
  // Demo schedule data for lecturer
  const [schedule] = useState({
    ...
    Wednesday: [
      ...
      },
      {
        ...
        students: 32,
        location: 'Room 401, Research Center',
        type: 'Lecture',
        institution: 'Baghdad International Academy',
      },
    ],
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold text-gray-800 dark:text-white">Teaching Schedule</h1>
            </div>
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-white/90 mt-1">Your weekly teaching schedule</p>
            </div>
          </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                      ...
                      <div>
                        ...
                        <p className="font-semibold">{session.students} enrolled</p>
                      </div>
                    </div>
